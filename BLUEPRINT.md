...
- **Image licensing.** `primary-source-verification.jpg`, `background-screening.jpg`, and `consultancy-meeting.jpg` were supplied as saved files; two of them look like stock-agency preview sizes (Shutterstock/iStock style). Before heavy commercial use, confirm they're properly licensed or replace with licensed/Unsplash equivalents. `hero-handshake.jpg` and `immigration-travel.jpg` are Unsplash (free license, no attribution required).
